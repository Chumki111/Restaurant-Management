          ...
          <div className="flex flex-wrap justify-between items-center text-black p-4">
            <div className="">
              ...
              <div className="flex space-x-5">
                <FaFacebookF className='border border-zinc-700 rounded-full text-4xl p-2 hover:bg-secondary hover:border-none transition duration-300' />
                <FaLinkedinIn className='border border-zinc-700 rounded-full text-4xl p-2 hover:bg-secondary hover:border-none transition duration-300' />
                <RxDiscordLogo className='border border-zinc-700 rounded-full text-4xl p-2 hover:bg-secondary hover:border-none transition duration-300' />
              </div>
            </div>
            <div className="mt-10 md:mt-0">
              <h2 className='text-[32px] font-semibold pb-5'>Link</h2>
              <div className="text-zinc-700 ">
                <span className='block hover:text-secondary transition duration-300 hover:translate-x-2'>Home</span>
